...
output_fn = "../../analysis/output_"+ time.strftime('%Y%m%d_%H%M%S') +".csv"
...
Ns = [1000, 5000, 10000, 20000, 30000, 40000, 50000, 60000, 70000, 80000, 90000, 100000, 500000, 1000000, 5000000]

 ...
 */
  ...
  } else if (unlikely(__pyx_t_4 >= __pyx_v_c.shape[0])) __pyx_t_3 = 0;
  if (__pyx_t_5 < 0) {
    __pyx_t_5 += __pyx_v_c.shape[1];
    if (unlikely(__pyx_t_5 < 0)) __pyx_t_3 = 1;
  } else if (unlikely(__pyx_t_5 >= __pyx_v_c.shape[1])) __pyx_t_3 = 1;
  if (unlikely(__pyx_t_3 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_3);
    __PYX_ERR(0, 17, __pyx_L1_error)
  }
  ...
  __pyx_t_3 = -1;
  if (__pyx_t_6 < 0) {
    __pyx_t_6 += __pyx_v_assign.shape[0];
    if (unlikely(__pyx_t_6 < 0)) __pyx_t_3 = 0;
  } else if (unlikely(__pyx_t_6 >= __pyx_v_assign.shape[0])) __pyx_t_3 = 0;
  if (unlikely(__pyx_t_3 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_3);
    __PYX_ERR(0, 17, __pyx_L1_error)
  }
  kMeans((&(*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_x.data + __pyx_t_1 * __pyx_v_x.strides[0]) )) + __pyx_t_2)) )))), (&(*((float *) ( /* dim=1 */ ((char *) (((float *) ( /* dim=0 */ (__pyx_v_c.data + __pyx_t_4 * __pyx_v_c.strides[0]) )) + __pyx_t_5)) )))), (&(*((int *) ( /* dim=0 */ ((char *) (((int *) __pyx_v_assign.data) + __pyx_t_6)) )))), __pyx_v_N, __pyx_v_K, __pyx_v_D);
...
static PyObject *__pyx_pw_9kmeansCPY_1kM(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("kM (wrapper)", 0);
  {
    ...
    __pyx_v_x = __Pyx_PyObject_to_MemoryviewSlice_d_dc_float(values[0]); if (unlikely(!__pyx_v_x.memview)) __PYX_ERR(0, 13, __pyx_L3_error)
    __pyx_v_c = __Pyx_PyObject_to_MemoryviewSlice_d_dc_float(values[1]); if (unlikely(!__pyx_v_c.memview)) __PYX_ERR(0, 13, __pyx_L3_error)
    __pyx_v_assign = __Pyx_PyObject_to_MemoryviewSlice_dc_int(values[2]); if (unlikely(!__pyx_v_assign.memview)) __PYX_ERR(0, 13, __pyx_L3_error)
  }

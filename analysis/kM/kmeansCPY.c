...
#define __PYX_HAVE__kmeansCPY
#define __PYX_HAVE_API__kmeansCPY
#include "string.h"
#include "stdlib.h"
...
#define __pyx_memoryview_copy_slice_dcd__double_f(slice)\
        __pyx_memoryview_copy_new_contig(&slice, "fortran", 2,\
                                         sizeof(double), (PyBUF_F_CONTIGUOUS | PyBUF_FORMAT | PyBUF_WRITABLE),\
                                         0)

/* CopyContentsUtility.proto */
#define __pyx_memoryview_copy_slice_dc_int_c(slice)\
        __pyx_memoryview_copy_new_contig(&slice, "c", 1,\
                                         sizeof(int), (PyBUF_C_CONTIGUOUS | PyBUF_FORMAT | PyBUF_WRITABLE),\
                                         0)
...
/* Module declarations from 'kmeansCPY' */
...
static int __pyx_f_9kmeansCPY_kM(__Pyx_memviewslice, __Pyx_memviewslice, __Pyx_memviewslice, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "kmeansCPY"
int __pyx_module_is_main_kmeansCPY = 0;

/* Implementation of 'kmeansCPY' */
...
static PyObject *__pyx_pf_9kmeansCPY_kM(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, __Pyx_memviewslice __pyx_v_c, __Pyx_memviewslice __pyx_v_assign); /* proto */
...
static PyObject *__pyx_pw_9kmeansCPY_1kM(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static int __pyx_f_9kmeansCPY_kM(__Pyx_memviewslice __pyx_v_x, __Pyx_memviewslice __pyx_v_c, __Pyx_memviewslice __pyx_v_assign, CYTHON_UNUSED int __pyx_skip_dispatch) {
  int __pyx_v_N;
  int __pyx_v_D;
  int __pyx_v_K;
  __Pyx_memviewslice __pyx_v_xC = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_cC = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_assignC = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_r;
  ...
  __PYX_INC_MEMVIEW(&__pyx_v_assign, 1);
 ...
 */
  __pyx_t_1 = __pyx_memoryview_copy_slice_d_dc_double_c(__pyx_v_x); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 18, __pyx_L1_error)
 ...
 * 
 */
  __pyx_t_1 = __pyx_memoryview_copy_slice_d_dc_double_c(__pyx_v_c); if (unlikely(!__pyx_t_1.memview)) __PYX_ERR(0, 19, __pyx_L1_error)
 ...
 */
  __pyx_t_2 = __pyx_memoryview_copy_slice_dc_int_c(__pyx_v_assign); if (unlikely(!__pyx_t_2.memview)) __PYX_ERR(0, 20, __pyx_L1_error)
  __pyx_v_assignC = __pyx_t_2;
 ...
 */
  ...
  __pyx_t_5 = -1;
  if (__pyx_t_3 < 0) {
    __pyx_t_3 += __pyx_v_xC.shape[0];
    if (unlikely(__pyx_t_3 < 0)) __pyx_t_5 = 0;
  } else if (unlikely(__pyx_t_3 >= __pyx_v_xC.shape[0])) __pyx_t_5 = 0;
  if (__pyx_t_4 < 0) {
    __pyx_t_4 += __pyx_v_xC.shape[1];
    if (unlikely(__pyx_t_4 < 0)) __pyx_t_5 = 1;
  } else if (unlikely(__pyx_t_4 >= __pyx_v_xC.shape[1])) __pyx_t_5 = 1;
  ...
  __pyx_t_5 = -1;
  if (__pyx_t_6 < 0) {
    __pyx_t_6 += __pyx_v_cC.shape[0];
    if (unlikely(__pyx_t_6 < 0)) __pyx_t_5 = 0;
  } else if (unlikely(__pyx_t_6 >= __pyx_v_cC.shape[0])) __pyx_t_5 = 0;
  if (__pyx_t_7 < 0) {
    __pyx_t_7 += __pyx_v_cC.shape[1];
    if (unlikely(__pyx_t_7 < 0)) __pyx_t_5 = 1;
  } else if (unlikely(__pyx_t_7 >= __pyx_v_cC.shape[1])) __pyx_t_5 = 1;
  if (unlikely(__pyx_t_5 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_5);
    __PYX_ERR(0, 22, __pyx_L1_error)
  }
  ...
  __pyx_t_5 = -1;
  if (__pyx_t_8 < 0) {
    __pyx_t_8 += __pyx_v_assignC.shape[0];
    if (unlikely(__pyx_t_8 < 0)) __pyx_t_5 = 0;
  } else if (unlikely(__pyx_t_8 >= __pyx_v_assignC.shape[0])) __pyx_t_5 = 0;
  if (unlikely(__pyx_t_5 != -1)) {
    __Pyx_RaiseBufferIndexError(__pyx_t_5);
    __PYX_ERR(0, 22, __pyx_L1_error)
  }
  kMeans((&(*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_xC.data + __pyx_t_3 * __pyx_v_xC.strides[0]) )) + __pyx_t_4)) )))), (&(*((double *) ( /* dim=1 */ ((char *) (((double *) ( /* dim=0 */ (__pyx_v_cC.data + __pyx_t_6 * __pyx_v_cC.strides[0]) )) + __pyx_t_7)) )))), (&(*((int *) ( /* dim=0 */ ((char *) (((int *) __pyx_v_assignC.data) + __pyx_t_8)) )))), __pyx_v_N, __pyx_v_K, __pyx_v_D);
 ...
 * 
 */
  __PYX_XDEC_MEMVIEW(&__pyx_v_assign, 1);
  __PYX_INC_MEMVIEW(&__pyx_v_assignC, 0);
  __pyx_v_assign = __pyx_v_assignC;
 ...
 */
  ...
  __PYX_INC_MEMVIEW(&__pyx_v_cC, 0);
  __pyx_v_c = __pyx_v_cC;
 ...
 */
  ...
  __Pyx_WriteUnraisable("kmeansCPY.kM", __pyx_clineno, __pyx_lineno, __pyx_filename, 0, 0);
  __pyx_r = 0;
  __pyx_L0:;
  __PYX_XDEC_MEMVIEW(&__pyx_v_xC, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_cC, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_assignC, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_c, 1);
  __PYX_XDEC_MEMVIEW(&__pyx_v_assign, 1);
...
/* Python wrapper */
static PyObject *__pyx_pw_9kmeansCPY_1kM(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_pw_9kmeansCPY_1kM(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  __Pyx_memviewslice __pyx_v_x = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_c = { 0, 0, { 0 }, { 0 }, { 0 } };
  __Pyx_memviewslice __pyx_v_assign = { 0, 0, { 0 }, { 0 }, { 0 } };
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("kM (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_x,&__pyx_n_s_c,&__pyx_n_s_assign,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_c)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("kM", 1, 3, 3, 1); __PYX_ERR(0, 13, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_assign)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("kM", 1, 3, 3, 2); __PYX_ERR(0, 13, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "kM") < 0)) __PYX_ERR(0, 13, __pyx_L3_error)
      }
    ...
    __pyx_v_x = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[0]); if (unlikely(!__pyx_v_x.memview)) __PYX_ERR(0, 13, __pyx_L3_error)
    __pyx_v_c = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[1]); if (unlikely(!__pyx_v_c.memview)) __PYX_ERR(0, 13, __pyx_L3_error)
    __pyx_v_assign = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[2]); if (unlikely(!__pyx_v_assign.memview)) __PYX_ERR(0, 13, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("kM", 1, 3, 3, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 13, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("kmeansCPY.kM", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_9kmeansCPY_kM(__pyx_self, __pyx_v_x, __pyx_v_c, __pyx_v_assign);
...
static PyObject *__pyx_pf_9kmeansCPY_kM(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_x, __Pyx_memviewslice __pyx_v_c, __Pyx_memviewslice __pyx_v_assign) {
  ...
  if (unlikely(!__pyx_v_c.memview)) { __Pyx_RaiseUnboundLocalError("c"); __PYX_ERR(0, 13, __pyx_L1_error) }
  if (unlikely(!__pyx_v_assign.memview)) { __Pyx_RaiseUnboundLocalError("assign"); __PYX_ERR(0, 13, __pyx_L1_error) }
  __pyx_t_1 = __Pyx_PyInt_From_int(__pyx_f_9kmeansCPY_kM(__pyx_v_x, __pyx_v_c, __pyx_v_assign, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 13, __pyx_L1_error)
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "kmeansCPY._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"kM", (PyCFunction)__pyx_pw_9kmeansCPY_1kM, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initkmeansCPY(void); /*proto*/
PyMODINIT_FUNC initkmeansCPY(void)
#else
PyMODINIT_FUNC PyInit_kmeansCPY(void); /*proto*/
PyMODINIT_FUNC PyInit_kmeansCPY(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_kmeansCPY(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("kmeansCPY", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_kmeansCPY) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "kmeansCPY")) {
      if (unlikely(PyDict_SetItemString(modules, "kmeansCPY", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init kmeansCPY", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init kmeansCPY");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
